...
# Now reassign a new value to the variable `x`, this value should be a 
#string, e.g "hello", check the type of 
# the variable `x` again.
# What did you observe?
#I OBSERVE THAT USING THE VARIABLES WE CAN CHANGE THE DATA TYPE.
# LIKE IN X WE CHANGED THE INTEGER TO A STRING,
